...
const ServicesCards = () => {
  return (
    <section className="flex flex-wrap items-center max-w-screen-xxl justify-center">
      {services.map((item) => (
        <div
          data-aos="zoom-in"
          ...
          key={item.name}
        >
          <div className="flex-shrink-0 m-6 relative overflow-hidden bg-[#1e293b] rounded-lg lg:min-w-[22.5rem] lg:max-w-[22.5rem] min-w-[80vw] max-w-[80vw] lg:h-[25rem] h-[27.5rem] shadow-lg hover:bg-[#004b9a50] border-solid hover:border-2 border-l-[#2e6dd0] border-transparent border-2 hover:scale-105">
            <svg
